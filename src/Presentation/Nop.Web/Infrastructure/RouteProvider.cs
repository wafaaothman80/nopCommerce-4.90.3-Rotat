...
public partial class RouteProvider : BaseRouteProvider, IRouteProvider
{
    ...
    public virtual void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        endpointRouteBuilder.MapControllerRoute(name: "CreditAndInvoices",
     pattern: $"{lang}/CreditAndInvoices",
     defaults: new { controller = "Home", action = "CreditAndInvoices" });
        endpointRouteBuilder.MapControllerRoute(name: "DimensionSearch",
    pattern: $"{lang}/dimensionsearch/search",
    defaults: new { controller = "DimensionSearch", action = "Search" });

        endpointRouteBuilder.MapControllerRoute(name: "RegisterCustomerOTP",
     pattern: $"{lang}/RegisterCustomerOTP",
     defaults: new { controller = "Home", action = "RegisterCustomerOTP" });
        endpointRouteBuilder.MapControllerRoute(name: "CustomerOTP",
           pattern: $"{lang}/CustomerOTP/{{UserName}}",
           defaults: new { controller = "Home", action = "CustomerOTP" });

        endpointRouteBuilder.MapControllerRoute(name: "SendCustomerOTP",
      pattern: $"{lang}/SendCustomerOTP/{{CurrentCustomerId}}/{{UserName}}",
      defaults: new { controller = "Home", action = "SendCustomerOTP" });

        endpointRouteBuilder.MapControllerRoute(name: "ConfirmOTP",
       pattern: $"{lang}/ConfirmOTP/{{CID}}/{{OTP}}",
       defaults: new { controller = "Home", action = "ConfirmOTP" });

        endpointRouteBuilder.MapControllerRoute(name: "GetLatestCategories",
   pattern: $"{lang}/GetLatestCategories",
   defaults: new { controller = "Home", action = "GetLatestCategories" });
