...
public partial record CustomerModel : BaseNopEntityModel, IAclSupportedModel
{
    ...
    //by wafaa 26-6
    [NopResourceDisplayName("Admin.Customers.Customers.Fields.IsRegisteredEmail")]
    public bool ERPIsRegisteredEmail { get; set; }
    [NopResourceDisplayName("Admin.Customers.Customers.Fields.IsRegisteredPhone")]
    public bool ERPIsRegisteredPhone { get; set; }
    [NopResourceDisplayName("Admin.Customers.Customers.Fields.ERPCustomerId")]
    public int ERPCustomerId { get; set; }
    [NopResourceDisplayName("Admin.Customers.Customers.Fields.ERPRegisteredCIdsByEmail")]
    public string ERPRegisteredCIdsByEmail { get; set; }
    [NopResourceDisplayName("Admin.Customers.Customers.Fields.ERPRegisteredCIdsByPhone")]
    public string ERPRegisteredCIdsByPhone { get; set; }
    // Wafaa: ERP action selection for active customers
    [NopResourceDisplayName("Admin.Customers.Fields.ERPAction")]
    public int ERPAction { get; set; }

    public IList<SelectListItem> AvailableERPActions { get; set; } = new List<SelectListItem>();

    [NopResourceDisplayName("Admin.Customers.Fields.ERPCustomerIdToUpdate")]
    public int ERPCustomerIdToUpdate { get; set; }


    public IList<SelectListItem> AvailableCustomerTypes { get; set; }
    public IList<SelectListItem> AvailableCODCountries { get; set; }

    [NopResourceDisplayName("Admin.Customers.Customers.Fields.SelectedCODCountryId")]
    [Required(ErrorMessage = "Admin.Customers.SelectedCODCountryId.Required")]
    public string SelectedCODCountryId { get; set; }

    public IList<SelectListItem> AvailableCustomerType { get; set; }

    [NopResourceDisplayName("Admin.Customers.Customers.Fields.SelectedCustomerTypeId")]
    [Range(1, int.MaxValue, ErrorMessage = "Admin.Customers.SelectedCustomerTypeId.Required")]
    public int SelectedCustomerTypeId { get; set; }

    // Account Manager multi-select
    [NopResourceDisplayName("Admin.Customers.Customers.Fields.SelectedAccountManagerIds")]
    public IList<int> SelectedAccountManagerIds { get; set; } = new List<int>();
    public IList<SelectListItem> AvailableAccountManagers { get; set; } = new List<SelectListItem>();
    // The single AM marked as primary
