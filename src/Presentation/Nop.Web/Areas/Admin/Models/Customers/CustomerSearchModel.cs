...
public partial record CustomerSearchModel : BaseSearchModel, IAclSupportedModel
{
    ...
    public CustomerSearchModel()
    {
        ...
        SelectedAccountManagerIds = new List<int>();
        AvailableAccountManagers = new List<SelectListItem>();
    }
    ...
    [NopResourceDisplayName("Admin.Customers.Customers.List.AccountManagers")]
    public IList<int> SelectedAccountManagerIds { get; set; }

    public IList<SelectListItem> AvailableAccountManagers { get; set; }
    ...
    [NopResourceDisplayName("Admin.Customers.Customers.List.SearchERPCustomerId")]
    public int? SearchERPCustomerId { get; set; }
