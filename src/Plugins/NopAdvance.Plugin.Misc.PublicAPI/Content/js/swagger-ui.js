(function () {
    window.addEventListener("load", function () {
        setTimeout(function () {
            ...
            logo[0].href = "https://nopadvance.com/";
            logo[0].target = "_blank";

            // Section 02 - Set logo
            logo[0].children[0].alt = "NopAdvance";
            logo[0].children[0].src = "/Plugins/NopAdvance.Plugin.PublicAPI/Content/images/nopadvance-logo.png";

            // Section 03 - Set 32x32 favicon
            var linkIcon32 = document.createElement('link');
            linkIcon32.type = 'image/png';
            linkIcon32.rel = 'icon';
            linkIcon32.href = '/Plugins/NopAdvance.Plugin.PublicAPI/Content/images/favicon-32x32.png';
            ...
            linkIcon16.rel = 'icon';
            linkIcon16.href = '/Plugins/NopAdvance.Plugin.PublicAPI/Content/images/favicon-16x16.png';
