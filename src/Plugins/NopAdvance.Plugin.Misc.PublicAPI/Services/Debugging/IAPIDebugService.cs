...
{
    Task InsertDebug(APIDebugLog apiDebug);
    ...
    /// </returns>
    Task<IPagedList<APIDebugLog>> GetAllAPIDebugLogsAsync(int storeId = 0,int applicationId = 0,
    ...
    /// </returns>
    Task<APIDebugLog> GetAPIDebugLogByDebugIdAsync(int debugLogId);

    /// <summary>
    /// Clears a debug log
    /// </summary>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task ClearDebugLogAsync();
    ...
    /// </returns>
    Task<IList<APIDebugLog>> GetAPIDebugLogByIdsAsync(int[] debugLogIds);
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    Task DeleteAPIDebugLogAsync(APIDebugLog debugLog);
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    Task DeleteAPIDebugLogsAsync(IList<APIDebugLog> debugLogs);
}
