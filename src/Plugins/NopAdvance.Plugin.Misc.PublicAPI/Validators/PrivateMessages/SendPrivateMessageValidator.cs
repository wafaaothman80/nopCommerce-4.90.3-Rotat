...
namespace NopAdvance.Plugin.Misc.PublicAPI.Validators.PrivateMessages;

public partial class SendPrivateMessageValidator : BaseNopValidator<SendPrivateMessageRequest>
{
