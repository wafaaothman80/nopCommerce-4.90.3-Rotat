...
public partial record ApplyGiftCardResponse
{
    public ApplyGiftCardResponse()
    {
        GiftCardBox = new ShoppingCartModel.GiftCardBoxModel();
    ...
    /// Gift card model
    /// </summary>
    public ShoppingCartModel.GiftCardBoxModel GiftCardBox { get; set; }
