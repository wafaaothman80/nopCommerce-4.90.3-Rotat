...
public partial record RigionSearchModel : BaseSearchModel, ISupportedRigionModel
{
    #region Ctor

    public RigionSearchModel()
    {
    ...
    [NopResourceDisplayName("Admin.Rigion.SelectedCountryIds")]
