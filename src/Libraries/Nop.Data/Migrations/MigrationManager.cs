...
public partial class MigrationManager : IMigrationManager
{
    ...
    public MigrationManager(
        ...
        Lazy<IVersionLoader> versionLoader, ILogger logger)
    {
    ...
    {
        ArgumentNullException.ThrowIfNull(migrationInfo);
        _logger.LogInformation($"[MIGRATION] Applying: {migrationInfo.Version} | {migrationInfo.Description} | {migrationInfo.Migration.GetType().FullName}");
        ...
        _logger.LogInformation($"[MIGRATION] Applied OK: {migrationInfo.Version}");
    }
